...
select j.officecode, a.contractno, b.deliveryseq as deliveryno, a.currency, sum(t.RevisedQuantity) as qty, sum(t.costprice * t.RevisedQuantity) as amt, bt.importdate, pt.code as productteamcode, pt.description as productteamdesc, b.RevisedDeliveryDate, sum(t.costprice * t.RevisedQuantity * ex1.exchangerate / ex2.exchangerate) as amt_usd 
...
group by a.contractno, b.deliveryseq, a.currency,j.officecode, bt.importdate, pt.code , pt.description, b.RevisedDeliveryDate
having sum(t.costprice * t.RevisedQuantity) > 0


select * from product where itemno = '477366'