<%@ Page Language="C#" Theme="DefaultTheme" AutoEventWireup="true" CodeBehind="UKClaimRefundEdit.aspx.cs" Inherits="com.next.isam.webapp.claim.UKClaimRefundEdit" Title="Next Claim Refund Edit" %>
...
<script type="text/javascript">
    ...
    <asp:Panel ID="Panel1" runat="server" SkinID="SectionHeader_Accounts" >Next Claim Refund - Edit</asp:Panel>
    </div>
                ...
                <td>
                    <table style="margin-left:10px;" cellpadding="5" cellspacing="0" >
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <cc2:SmartDropDownList ID="ddl_SettlementOption" runat="server" width="100px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="FieldLabel2"/>
                            <td colspan="3">
                                <asp:CheckBox runat="server" ID="chkIsReadyForSettlement" Text="Ready For Settlement" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <hr />
                                <asp:Panel ID="pnl_CreditNote" runat="server" skinid="sectionHeader2"  Height="22" >
                                    <div style="float:left;padding:3px;vertical-align:middle;" class="header2">Credit Note</div>
                                </asp:Panel>
                            </td>
                        </tr>
                        <tr>
                            <td class="FieldLabel2" width="100">Credit Note No.</td>
                            <td>
                                <asp:TextBox ID="txt_CreditNoteNo" runat="server" Enabled="false" style="width:90px;"/>
                            </td>
                            <td class="FieldLabel2">Credit Note Date</td>
                            <td>
                                <asp:TextBox ID="txt_CreditNoteDate" runat="server" Enabled="false" style="width:70px;"/>
                            </td>
                        </tr>
                        <tr style="display:none;">
                            <td class="FieldLabel2" >Credit Note Amount</td>
                            <td>
                                <asp:TextBox ID="txt_CreditNoteAmt" runat="server" Enabled="false" style="width:90px;"/>
                            </td>          
                        </tr>
                   </table>            
                </td>
