<%@ Page Language="C#" Theme="DefaultTheme" AutoEventWireup="true" CodeBehind="UploadDoc.aspx.cs" Inherits="com.next.isam.webapp.claim.UploadDoc" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="2" cellpadding="2" border="0">
            ...
            <tr>
                <td width="100"><b><span style="color:Black;font-size:8pt;">Next D/N No:</span></b></td>
                <td width="250"><asp:Label runat="server" ID="lbl_UKDNNo" /></td>
            </tr>
            <tr>
                <td><b><span style="color:Black;font-size:8pt;">Claim Type:</span></b></td>
                <td><asp:Label ID="lbl_ClaimType" runat="server" /></td>
            </tr>
            <tr>
