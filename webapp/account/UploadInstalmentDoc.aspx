<%@ Page Language="C#" Theme="DefaultTheme" AutoEventWireup="true" CodeBehind="UploadInstalmentDoc.aspx.cs" Inherits="com.next.isam.webapp.account.UploadInstalmentDoc" %>
...
<body>
    ...
    <asp:validationsummary id="vs" runat="server"></asp:validationsummary>
        <table cellspacing="2" cellpadding="2" border="0">
            ...
            <tr>
                <td width="100"><b><span style="color:Black;font-size:8pt;">Payment No:</span></b></td>
                <td width="250"><asp:Label runat="server" ID="lbl_PaymentNo" /></td>
            </tr>
            <tr>
                <td><b><span style="color:Black;font-size:8pt;">Supplier Name:</span></b></td>
                <td><asp:Label runat="server" ID="lbl_SupplierName" /></td>
            </tr>
        </table>
		...
		<p>
            ...
            <asp:Button id="btnRemove" runat="server" CssClass="btn" Text="Comfirm" onclick="btnSave_Click"></asp:Button>&nbsp;&nbsp;&nbsp;
