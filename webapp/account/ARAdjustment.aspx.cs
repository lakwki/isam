...
{
    public partial class ARAdjustment : com.next.isam.webapp.usercontrol.PageTemplate
    {
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ReportClass report = AccountManager.Instance.generateAdjustmentNote(int.Parse(ddl_Office.SelectedValue), AdjustmentType.SALES_ADJUSTMENT.Id, this.radDraft.Checked ? true : false, this.radDraft.Checked ? DateTime.MinValue : txtIssueDate.DateTime, this.LogonUserId);
