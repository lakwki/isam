<%@ Page Title="ISAM - ILS Price Difference Debit / Credit Note" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" Theme="DefaultTheme" AutoEventWireup="true"
    CodeBehind="ILSDiffDCNote.aspx.cs" Inherits="com.next.isam.webapp.account.ILSDiffDCNote" %>
...
-->
    <asp:Panel ID="Panel1" runat="server" SkinID="SectionHeader_Accounts">ILS Price Difference Debit / Credit Note</asp:Panel>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="600px">
        <tr>
            ...
            <td>
                <cc1:SmartDropDownList ID="ddl_Office" runat="server" Width="147" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="FieldLabel2">Debit / Credit Note Date</td>
            <td>
                <cc1:SmartCalendar ID="txt_DebitNoteDate" runat="server" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="btn_Submit" runat="server" Text="Submit" OnClientClick="return isValid();" OnClick="btn_Submit_Click" />
            </td>
        </tr>
    </table>
