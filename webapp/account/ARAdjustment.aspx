<%@ Page Language="C#" Theme="DefaultTheme" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="ARAdjustment.aspx.cs" Inherits="com.next.isam.webapp.account.ARAdjustment" Title="A/R Adjustment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_ImageHeader" runat="server">
    <asp:Panel ID="Panel1" runat="server" SkinID="SectionHeader_Accounts">A/R Adjustment</asp:Panel>
</asp:Content>
...
<br />
<br />
<font color="red">* Only EziBuy invoices will be catered.</font>
</asp:Content>