<%@ Page Title="ISAM - Studio Sample Debit Note" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" Theme="DefaultTheme" AutoEventWireup="true" 
CodeBehind="StudioSampleDebitNote.aspx.cs" Inherits="com.next.isam.webapp.account.StudioSampleDebitNote" %>
...
-->
<asp:Panel ID="Panel1" runat="server" SkinID="SectionHeader_Accounts">Studio Sample Debit Note</asp:Panel>
</asp:Content>
...
<table width="600px">
    ...
    <tr>
        ...
        * Only Studio Sample Invoices will be included for Studio Sample Debit Note.
        </td>
    </tr>
</table>
