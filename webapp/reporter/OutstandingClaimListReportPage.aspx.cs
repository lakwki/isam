...
{
    public partial class OutstandingClaimListReportPage : com.next.isam.webapp.usercontrol.PageTemplate
    {
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (this.IsValid)
            {
                ...
                TypeCollector wfs = TypeCollector.Exclusive;
                if (this.ckbExcludeCancel.Checked)
                    wfs.append(10).append(99);
                Context.Items.Add(AccountCommander.Param.workflowStatusList, wfs);
