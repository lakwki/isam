...
{
    public partial class DiscountClaimListReport : com.next.isam.webapp.usercontrol.PageTemplate
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment;filename=DiscountClaimList.xls");
        ...
        private void getReport()
        {
            ...
            List<UKDiscountClaimRefundDef> refundList = (List<UKDiscountClaimRefundDef>)Context.Items[AccountCommander.Param.claimRefundList];
            ...
            //foreach(UKDiscountClaimDef def in list)
            //{
            ...
            foreach (UKDiscountClaimRefundDef def in refundList)
            {
                UKDiscountClaimDef claimDef = UKClaimManager.Instance.getUKDiscountClaimByKey(def.ClaimId);
        ...
        protected void repUKClaim_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            */
            ...
            ((Label)e.Item.FindControl("lbl_Vendor")).Text = VendorWorker.Instance.getVendorByKey(def.VendorId).Name;
            ...
            ((Label)e.Item.FindControl("lbl_Currency")).Text = GeneralWorker.Instance.getCurrencyByKey(def.CurrencyId).CurrencyCode;
            ...
            */
            ...
            {
                decimal baseAmt = def.Amount * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.CurrencyId, def.UKDebitNoteReceivedDate) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, def.UKDebitNoteReceivedDate);
                ((Label)e.Item.FindControl("lbl_AmountInUSD")).Text = baseAmt.ToString("#,##0.00");
            }
