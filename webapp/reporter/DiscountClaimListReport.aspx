<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscountClaimListReport.aspx.cs" Inherits="com.next.isam.webapp.reporter.DiscountClaimListReport" EnableViewState="false" %>
...
<body>
    ...
    <tr>
        <td id="tdReportHeaderRow1" runat="server" colspan="23" style="text-align:left; font-size:larger; border-style:none; vertical-align:top;">NEXT SOURCING LIMITED
        </td>
        
        <td style="text-align:left; font-size:larger; border-style:none;">
    ...
    <tr>
        ...
        <td class="lockedHeader" style="width:100px; text-align:left;" x:autofilter='all'>Contract No.</td>
