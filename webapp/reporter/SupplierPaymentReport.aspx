<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" Theme="DefaultTheme"  AutoEventWireup="true" CodeBehind="SupplierPaymentReport.aspx.cs" Inherits="com.next.isam.webapp.reporter.SupplierPaymentReport" Title="Supplier Payment Report" %>
...
<!--
<img src="../images/banner_reports_supplier_payment.gif" runat="server" id="imgHeaderText" />
-->
<asp:Panel ID="Panel1" runat="server" SkinID="sectionHeader_Report">Supplier Payment Report</asp:Panel>
...
//            document.getElementById("ctl00_ContentPlaceHolder1_txt_InvoiceUploadDateTo_txt_textbox").value == "" &&
            document.getElementById("ctl00_ContentPlaceHolder1_txt_PaymentDateFrom_txt_PaymentDateFrom_textbox").value == "" &&
            document.getElementById("ctl00_ContentPlaceHolder1_txt_PaymentDateTo_txt_PaymentDateTo_textbox").value == "" &&                        
...
<tr>
    <td class="FieldLabel4" style="width:150px;">Payment Date</td>
    <td><cc2:SmartCalendar ID="txt_PaymentDateFrom" runat="server" FromDateControl="txt_PaymentDateFrom" ToDateControl="txt_PaymentDateTo" />&nbsp;To&nbsp;<cc2:SmartCalendar 
        id="txt_PaymentDateTo" runat="server" FromDateControl="txt_PaymentDateFrom" ToDateControl="txt_PaymentDateTo" /></td>
</tr>
<tr>
    <td class="FieldLabel4" style="width:150px;">Fiscal Period</td>
    <td>
...
<tr>
    <td class="FieldLabel4_T" style="width:150px; vertical-align:top;">Customer</td>
...
<tr>
    <td class="FieldLabel4">Payment Reference No. </td>
    <td><cc2:SmartDropDownList ID="ddl_PaymentReferenceNo" runat="server" /></td>
</tr>
<tr>
    <td colspan="2">
