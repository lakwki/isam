<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" Theme="DefaultTheme"  AutoEventWireup="true" CodeBehind="InvoiceListReport.aspx.cs" Inherits="com.next.isam.webapp.reporter.InvoiceListReport" Title="Invoice Report" %>
...
-->
<asp:Panel ID="Panel1" runat="server" SkinID="sectionHeader_Report">Invoice List</asp:Panel> 
</asp:Content>
...
<tr>
    ...
    <table>
        <tr id="row_InvoiceDateRange" runat="server">
            <td><asp:RadioButton ID="rad_InvoiceDate" runat="server" GroupName="rad_SelectCriteria"  Checked="true" AutoPostBack="true" Text="By Range : " OnCheckedChanged="rad_InvoiceDate_CheckedChanged" /></td>
        ...
        <tr>
            <td id="col_Period" runat="server" ><asp:RadioButton ID="rad_FiscalPeriod" runat="server"  GroupName="rad_SelectCriteria" AutoPostBack="true" Text="By Period : " OnCheckedChanged="rad_FiscalPeriod_CheckedChanged" /></td>
...
<tr>
    ...
    <td><cc2:SmartCalendar ID="txt_PurchaseExtractDateFrom" runat="server" FromDateControl="txt_PurchaseExtractDateFrom"
        ToDateControl="txt_PurchaseExtractDateTo" />&nbsp;To&nbsp;<cc2:SmartCalendar ID="txt_PurchaseExtractDateTo" runat ="server" 
        FromDateControl="txt_PurchaseExtractDateFrom" ToDateControl="txt_PurchaseExtractDateTo" /></td>
</tr>
<tr>
    <td class="FieldLabel4">Departure Date</td>
    <td><cc2:SmartCalendar ID="txt_DepartDateFrom" runat="server" FromDateControl="txt_DepartDateFrom"
        ToDateControl="txt_DepartDateTo" />&nbsp;To&nbsp;<cc2:SmartCalendar ID="txt_DepartDateTo" runat ="server" 
        FromDateControl="txt_DepartDateFrom" ToDateControl="txt_DepartDateTo" /></td>
</tr>
<tr>
...
<tr>
    <td colspan="3">
        ...
        <asp:DropDownList ID="ddl_Office" runat="server" style="display:none;"  title="Add for compatiable to UclSmartSelection" ><asp:ListItem Selected="True" Value="-1">All</asp:ListItem> </asp:DropDownList>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td><cc2:SmartDropDownList ID="ddl_CustomerDestination" runat="server" /></td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        <asp:ImageButton ID="btn_Clear3" runat="server" ImageUrl="~/images/icon_clear_all.png" ToolTip="clear all" OnClientClick="UncheckAll('cbl_ShipmentMethod'); return false;" />&nbsp;
        <asp:ImageButton ID="btn_All3" runat="server" ImageUrl="~/images/icon_select_all.png" ToolTip="select all" OnClientClick="CheckAll('cbl_ShipmentMethod'); return false;" />
    </td>
</tr>
