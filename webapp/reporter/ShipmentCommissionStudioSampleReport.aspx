<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" Theme="DefaultTheme" AutoEventWireup="true" CodeBehind="ShipmentCommissionStudioSampleReport.aspx.cs" Inherits="com.next.isam.webapp.reporter.ShipmentCommissionStudioSampleReport" Title="Shipment and Commission Statement (Studio Sample)" %>
...
<script type="text/javascript">
    function isFormValid() {
        if ((document.getElementById("ctl00_ContentPlaceHolder1_txt_MockShopDNNoFrom").value == "" &&
            ...
            alert("Please enter Studio Sample Debit Note Number.\r\n" );
            return false;
        }
        else
...
-->
<asp:Panel ID="Panel1" runat="server" SkinID="sectionHeader_Report" Width="109px">Shipment And Commission Statement (Studio Sample)</asp:Panel>
</asp:Content>
...
<tr>
    <td class="FieldLabel4" style="width:150px;">Studio Sample Debit Note No.</td>
