<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" Theme="DefaultTheme" CodeBehind="OutstandingTradePayableRpt.aspx.cs" Inherits="com.next.isam.webapp.reporter.OutstandingTradePayableRpt" Title="Outstanding Trade Payable Report" %>
...
<!--
<img src="../images/banner_reports_outstanding_payable_rpt.gif" runat="server" id="imgHeaderText" />
-->
<asp:Panel ID="Panel1" runat="server" SkinID="sectionHeader_Report">Outstanding Trade Payable Report</asp:Panel>
</asp:Content>
...
<script type="text/javascript" >
    function isFormValid() {
        ...
        if (document.getElementById("ctl00_ContentPlaceHolder1_txt_InvoiceUploadDateFrom_txt_InvoiceUploadDateFrom_textbox").value == "" &&
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateFrom_txt_AccountReceiptDateFrom_textbox").value == "" &&
            document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateTo_txt_AccountReceiptDateTo_textbox").value == "") {
            alert("Please enter search criteria on one of below search criteria.\r\n" +
                "- Invoice Date\r\n- Invoice Application Date\r\n- Fiscal Period\r\n- Account Doc. Receipt Date");
            return false;
        }
        ...
        if ((document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateFrom_txt_AccountReceiptDateFrom_textbox").value != "" &&
                document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateTo_txt_AccountReceiptDateTo_textbox").value == "") ||
                (document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateFrom_txt_AccountReceiptDateFrom_textbox").value == "" &&
                document.getElementById("ctl00_ContentPlaceHolder1_txt_AccountReceiptDateTo_txt_AccountReceiptDateTo_textbox").value != "")) {
            alert("Invalid Account Doc. Receipt Date");
            return false;
        }
...
<tr>
    ...
    <td><cc2:SmartCalendar ID="txt_CutOffDate" runat="server" onblur="formatDateString(this);" /></td>
</tr>
<tr>
    ...
    <asp:UpdatePanel ID="updatePanel2" runat="server" >
        ...
        <table cellspacing="0">
            <tr id="tr_InvoiceDate" runat="server" style="display:none;">
                <td>&nbsp;&nbsp;<asp:RadioButton ID="rad_InvoiceDate" runat="server" GroupName="rad_SelectCriteria"  Text=" By Range : " OnCheckedChanged="rad_InvoiceDate_CheckedChanged" AutoPostBack="true"/></td>
                <td>&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;Period From&nbsp;&nbsp;
                    <asp:DropDownList id="ddl_PeriodFrom" runat="server" 
...
<tr>
    <td class="FieldLabel4" style="width:135px;">Invoice Application Date</td>
...
<tr>
    <td class="FieldLabel4" style="width:135px;">Account Doc. Receipt Date</td>
    <td><cc2:SmartCalendar ID="txt_AccountReceiptDateFrom" runat="server" FromDateControl="txt_AccountReceiptDateFrom"
        ToDateControl="txt_AccountReceiptDateTo" />&nbsp;To&nbsp;<cc2:SmartCalendar ID="txt_AccountReceiptDateTo" runat ="server" 
        FromDateControl="txt_AccountReceiptDateFrom" ToDateControl="txt_AccountReceiptDateTo" />
    </td>
</tr>
<tr>
