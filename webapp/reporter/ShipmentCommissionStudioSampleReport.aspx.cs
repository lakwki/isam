...
{
    public partial class ShipmentCommissionStudioSampleReport : com.next.isam.webapp.usercontrol.PageTemplate
    {
        ...
        private ReportClass genReport(string outputType)
        {
            ...
            string MockShopDebitNoteNoFrom = "";
            string MockShopDebitNoteNoTo = "";
            ...
            if (txt_MockShopDNNoFrom.Text.Trim() != "" || txt_MockShopDNNoTo.Text.Trim() != "")
            {
                MockShopDebitNoteNoFrom = txt_MockShopDNNoFrom.Text.Trim();
                MockShopDebitNoteNoTo = txt_MockShopDNNoTo.Text.Trim();
                if (MockShopDebitNoteNoFrom == "")
                    MockShopDebitNoteNoFrom = MockShopDebitNoteNoTo;
                if (MockShopDebitNoteNoTo == "")
                    MockShopDebitNoteNoTo = MockShopDebitNoteNoFrom;
            }
            else
            {
                MockShopDebitNoteNoFrom = string.Empty;
                MockShopDebitNoteNoTo = string.Empty;
            }
            ...
            */
            ...
            ReportClass rpt = AccountReportManager.Instance.getShipmentAndCommissionReport(
            invoicePrefix, invoiceSeqFrom, invoiceSeqTo, invoiceYear, invoiceDateFrom, invoiceDateTo, invoiceUploadDateFrom, invoiceUploadDateTo,
            purchaseExtractDateFrom, purchaseExtractDateTo, budgetYear, periodFrom, isActual, isRealized, isAccrual, vendorId, baseCurrencyId,
            countryOfOriginId, officeId, -1, officeIdList, seasonId, productTeamList, customerTypeCollector, tradingAgencyCollector, departmentId, departmentIdList, termOfPurchase,
            isSZOrder, isUTOrder, isOPROrder, isLDPOrder, isTailoring, isSampleOrder, designSourceList, MockShopDebitNoteNoFrom, MockShopDebitNoteNoTo, supplierInvoiceNo,
            1, rad_SortField.SelectedValue, this.LogonUserId, outputType);
