...
{
    public partial class OutstandingClaimListReport : com.next.isam.webapp.usercontrol.PageTemplate
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment;filename=OSClaimList.xls");
                ...
                TypeCollector excludingWfs = (TypeCollector)Context.Items[AccountCommander.Param.workflowStatusList];
                this.lblReportRemark.Text = (excludingWfs != null && (excludingWfs.contains(10) && excludingWfs.contains(99)) ? "(Exclude Cancelled & Pending For Cancellation)" : "");
        ...
        private void getReport()
        {
            ...
            if (list == null)
            {
                ...
                list = UKClaimManager.Instance.getOutstandingUKClaimList(officeId, vendorId, termOfPurchaseId, cutOffDate, handlingOfficeId, ncOptionId);
            }
        ...
        private void buildVendorSummary()
        {
            ...
            UKClaimDef.UKClaimComparer.CompareType compareType;
            compareType = UKClaimDef.UKClaimComparer.CompareType.SupplierName;
            this.vwSearchResult.Sort(new UKClaimDef.UKClaimComparer(compareType, SortDirection.Ascending));
            int vendorId = 0;
            int productTeamId = 0;
            ...
            foreach (UKClaimDef def in this.vwSearchResult)
            {
                isHardGoods = false;
                /*
                ...
                */
                ...
                if (vendorId != def.Vendor.VendorId)
                {
                ...
                if (t.Days >= 0 && t.Days <= 30)
                    aging1Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                else if (t.Days >= 31 && t.Days <= 60)
                    aging2Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                else if (t.Days >= 61 && t.Days <= 90)
                    aging3Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                else if (t.Days >= 91 && t.Days <= 120)
                    aging4Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                else if (t.Days > 120)
                    aging5Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
        ...
        private void buildRevaluationSummary(decimal gbpRate, decimal eurRate, decimal gbpAccrualAmt, decimal eurAccrualAmt, decimal usdAccrualAmt)
        {
            ...
            this.summaryList.Clear();
            UKClaimDef.UKClaimComparer.CompareType compareType;
            compareType = UKClaimDef.UKClaimComparer.CompareType.CurrencyId;
            this.vwSearchResult.Sort(new UKClaimDef.UKClaimComparer(compareType, SortDirection.Ascending));
            int currencyId = 0;
            decimal amt = 0;
            decimal aging1Amt = 0;
            ...
            foreach (UKClaimDef def in this.vwSearchResult)
            {
                ...
                cnt += 1;
                amtOriginal += ((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount);
                amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                ...
                if (t.Days >= 0 && t.Days <= 30)
                {
                    aging1AmtOriginal += Math.Round(((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount), 2, MidpointRounding.AwayFromZero);
                    aging1Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 31 && t.Days <= 60)
                {
                    aging2AmtOriginal += Math.Round(((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount), 2, MidpointRounding.AwayFromZero);
                    aging2Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 61 && t.Days <= 90)
                {
                    aging3AmtOriginal += Math.Round(((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount), 2, MidpointRounding.AwayFromZero);
                    aging3Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 91 && t.Days <= 120)
                {
                    aging4AmtOriginal += Math.Round(((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount), 2, MidpointRounding.AwayFromZero);
                    aging4Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days > 120)
                {
                    aging5AmtOriginal += Math.Round(((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount), 2, MidpointRounding.AwayFromZero);
                    aging5Amt += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                isFirst = false;
            }
        ...
        protected void repUKClaim_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            else if (WebHelper.isRepeaterNormalItemType(e))
            {
                ...
                ((Label)e.Item.FindControl("lbl_UKDNDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteDate : def.CreateDate);
                ((Label)e.Item.FindControl("lbl_M_UKDNDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteDate : def.CreateDate);
                ((Label)e.Item.FindControl("lbl_PC_UKDNDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteDate : def.CreateDate);
                ((Label)e.Item.FindControl("lbl_UKDNReceivedDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteReceivedDate : def.CreateDate);
                ((Label)e.Item.FindControl("lbl_M_UKDNReceivedDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteReceivedDate : def.CreateDate);
                ((Label)e.Item.FindControl("lbl_PC_UKDNReceivedDate")).Text = DateTimeUtility.getDateString(def.Type != UKClaimType.BILL_IN_ADVANCE ? def.UKDebitNoteReceivedDate : def.CreateDate);
                ...
                if (def.ProductTeamId != 0)
                {
                    ...
                    ((Label)e.Item.FindControl("lbl_M_DeptCode")).Text = (def.OfficeId == OfficeId.DG.Id ? CommonUtil.getProductCodeDefByKey(def.ProductTeamId).CodeDescription : CommonUtil.getProductCodeDefByKey(def.ProductTeamId).Code);
                    ((Label)e.Item.FindControl("lbl_PC_DeptCode")).Text = (def.OfficeId == OfficeId.DG.Id ? CommonUtil.getProductCodeDefByKey(def.ProductTeamId).CodeDescription : CommonUtil.getProductCodeDefByKey(def.ProductTeamId).Code);
                }
                else
                {
                ...
                */
                ...
                ((Label)e.Item.FindControl("lbl_M_Qty")).Text = def.Quantity.ToString("#,##0");
                ((Label)e.Item.FindControl("lbl_PC_Qty")).Text = def.Quantity.ToString("#,##0");
                ((Label)e.Item.FindControl("lbl_Amount")).Text = ((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount).ToString("#,##0.00");
                ((Label)e.Item.FindControl("lbl_M_Amount")).Text = ((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount).ToString("#,##0.00");
                ((Label)e.Item.FindControl("lbl_PC_Amount")).Text = ((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount).ToString("#,##0.00");
                ((Label)e.Item.FindControl("lbl_AmountInUSD")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                ((Label)e.Item.FindControl("lbl_M_AmountInUSD")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                ((Label)e.Item.FindControl("lbl_PC_AmountInUSD")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");

                totalUSD += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                subtotalUSD += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                ...
                if (t.Days >= 0 && t.Days <= 30)
                {
                    ((Label)e.Item.FindControl("lbl_Aging1")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_M_Aging1")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_PC_Aging1")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    totalAging1 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                    subtotalAging1 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 31 && t.Days <= 60)
                {
                    ((Label)e.Item.FindControl("lbl_Aging2")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_M_Aging2")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_PC_Aging2")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    totalAging2 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                    subtotalAging2 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 61 && t.Days <= 90)
                {
                    ((Label)e.Item.FindControl("lbl_Aging3")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_M_Aging3")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_PC_Aging3")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    totalAging3 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                    subtotalAging3 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days >= 91 && t.Days <= 120)
                {
                    ((Label)e.Item.FindControl("lbl_Aging4")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_M_Aging4")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_PC_Aging4")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    totalAging4 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                    subtotalAging4 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                else if (t.Days > 120)
                {
                    ((Label)e.Item.FindControl("lbl_Aging5")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_M_Aging5")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    ((Label)e.Item.FindControl("lbl_PC_Aging5")).Text = (((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))).ToString("#,##0.00");
                    totalAging5 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                    subtotalAging5 += Math.Round((((def.Type == UKClaimType.BILL_IN_ADVANCE || def.UKDebitNoteReceivedDate == DateTime.MinValue) ? def.Amount * -1 : def.Amount) * CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, def.Currency.CurrencyId, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate)) / CommonWorker.Instance.getExchangeRate(ExchangeRateType.INVOICE, CurrencyId.USD.Id, (def.UKDebitNoteReceivedDate == DateTime.MinValue ? DateTime.Today : def.UKDebitNoteReceivedDate))), 2, MidpointRounding.AwayFromZero);
                }
                ...
                ((Label)e.Item.FindControl("lbl_FormIssueDate")).Text = "N/A";
                ((Label)e.Item.FindControl("lbl_M_FormIssueDate")).Text = "N/A";
                ((Label)e.Item.FindControl("lbl_PC_FormIssueDate")).Text = "N/A";
                ...
                ((Label)e.Item.FindControl("lbl_IsAuthorized")).Text = "N/A";
                ((Label)e.Item.FindControl("lbl_M_IsAuthorized")).Text = "N/A";
                ((Label)e.Item.FindControl("lbl_PC_IsAuthorized")).Text = "N/A";
                /*
                ...
                */
                ...
                if (def.ClaimRequestId > 0)
                {
                    ...
                    */
                    ...
                    // check the claim is covered by bill in advance
                    List<string> BIAList = UKClaimManager.Instance.getUKClaimBIAMappingByKey(def.ClaimId);

                    ((Label)e.Item.FindControl("lbl_QAISStatus")).Text = BIAList.Count > 0 ? "BILL IN ADVANCE" : requestDef.WorkflowStatus.Name + (requestDef.BIAStatus == 2 ? " (BIA)" : string.Empty);
                ...
                */
                ...
                tr_Normal.Visible = ((def.ClaimRequestId > 0 && requestDef.WorkflowStatusId != 10) || def.Type.Id == UKClaimType.AUDIT_FEE.Id || def.Type.Id == UKClaimType.GB_TEST.Id || def.Type.Id == UKClaimType.BILL_IN_ADVANCE.Id);
                ...
                tr_PendingCancellation.Visible = (def.ClaimRequestId > 0 && requestDef.WorkflowStatusId == 10);
                isFirst = false;
