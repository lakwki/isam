<%@ Page Language="C#" Theme="DefaultTheme" AutoEventWireup="true" CodeBehind="AttachmentList.aspx.cs" Inherits="com.next.isam.webapp.nontrade.AttachmentList"  Title="DMS Uploaded Document" %>
...
<body>
    <form id="form1" runat="server"  >
        <table>
            ...
            <tr>
                <td><b>NSL Invoice No.:</b></td>
                <td><asp:Label runat="server" ID="lbl_NSLInvoiceNo" /></td>
            </tr>
            <tr>
                <td><b>Supplier Invoice No:</b></td>
                <td><asp:Label runat="server" ID="lbl_SupplierInvoiceNo" /></td>
            </tr>
            <tr>
                <td><b>Currency:</b></td>
            ...
            <tr>
                <td><b>Amount:</b></td>
                <td><asp:Label ID="lbl_Amount" runat="server" /></td>
            </tr>
        </table>
