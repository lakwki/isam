...
namespace com.next.isam.reporter.accounts {
    ...
    public class NTRechargeDCNote : ReportClass {
        
        public NTRechargeDCNote() {
        }
        
        public override string ResourceName {
            get {
                return "NTRechargeDCNote.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "com.next.isam.reporter.accounts.NTRechargeDCNote.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNTRechargeDCNote : Component, ICachedReport {
        
        public CachedNTRechargeDCNote() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NTRechargeDCNote rpt = new NTRechargeDCNote();
            rpt.Site = this.Site;
            return rpt;
        }
