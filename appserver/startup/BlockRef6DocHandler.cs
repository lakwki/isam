...
{
    public class BlockRef6DocHandler : IStartupHandler
    {
        private static readonly string DEFAULT_NAME = "BlockRef6DocHandler";
        ...
        {
            return BlockRef6DocHandler.DEFAULT_NAME;
        }
