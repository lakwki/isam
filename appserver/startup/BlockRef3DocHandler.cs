...
{
    public class BlockRef3DocHandler : IStartupHandler
    {
        private static readonly string DEFAULT_NAME = "BlockRef3DocHandler";
        ...
        {
            return BlockRef3DocHandler.DEFAULT_NAME;
        }
        ...
        public void runNow()
        {
            this.upload2Documents();
        }


        private void upload2Documents()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < docFiles.Length; i++)
                {
                    ...
                    /*
                    queryStructs.Add(new QueryStructDef("DOCUMENTTYPE", "TobyType"));
                    queryStructs.Add(new QueryStructDef("ContractDelivery", fi.Name.Substring(0, fi.Name.IndexOf('.')).ToUpper()));
                    */

                    queryStructs.Add(new QueryStructDef("DOCUMENTTYPE", "Shipping - UK Contract"));
                    queryStructs.Add(new QueryStructDef("UK Contract - Delivery", fi.Name.Substring(0, fi.Name.IndexOf('.')).ToUpper()));
                    ...
                    else
                    {
                        File.Copy(docFiles[i], uploadFolder + "Working\\" + fi.Name.Replace(",", ""), true);
                        attachmentList.Add(uploadFolder + "Working\\" + fi.Name.Replace(",", ""));
                        string msg = DMSUtil.CreateDocument(0, "\\Hong Kong\\Shipping\\2011/2012\\Next\\", blkName, "Shipping - UK Contract", queryStructs, attachmentList);
                        /*
                        string msg = DMSUtil.CreateDocument(0, "\\Hong Kong\\Shipping\\2011/2012\\Next\\", blkName, "TobyType", queryStructs, attachmentList);
                        */
                    }
